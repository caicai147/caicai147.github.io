...
categories: delphi之网络编程 深入学习之网络编程 delphi之消息机制
...
对应的程序点击[这里](../download/20170329/testScktComp.zip)

之前在[《Delphi网络编程：ServerSocket/ClientSocket的线程分布》](http://www.xumenger.com/01-delphi-socket-thread-20170103/)讲到回调并不是在主线程中。对于ClientSocket、ServerSocket，其是在哪个线程启动（Open）的，就会在哪个线程中回调
