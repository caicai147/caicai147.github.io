...
>对于32位的程序，它的地址范围是0x00000000~0xFFFFFFFF，假如页大小是4096 Byte，所以每页最多有000~FFF共1000个地址，所以每个虚拟地址比如0x0040AB20的后三位B20表示在某个内存页中的偏移，而前5位0040A表示内存页的页号
...
根据以上的输出，可以看到q[]的起始地址为0x0040AB20，q[199]的首地址是0x0040AE3C（q[]的结束地址是0x0040AE3C+4=0x0040AE40），当前正在访问元素的首地址是0x0040B09C
