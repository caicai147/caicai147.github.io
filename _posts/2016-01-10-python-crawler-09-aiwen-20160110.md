---
layout: post
title: Python爬虫之抓取爱问知识人问题并保存至数据库
categories: python之基础 python之网络爬虫
tags: python 爬虫 
---

转载自[静觅](http://cuiqingcai.com/)>>[Python爬虫实战六之抓取爱问知识人问题并保存至数据库](http://cuiqingcai.com/1972.html)
...
如果是ubuntu，可以直接使用如下命令安装Beautiful Soup和MySQLdb
...
好了，闲言碎语不多讲，直接上源码了，完整的代码可以点击这里下载[]()
...
![image](../media/image/2016-01-10/05.png)
