...
* 一般用户可以使用友言本身的帐号去评论，也可以使用它支持的`使用社交帐号登录`，比如微博、QQ等，不过假如你是博主，还是使用友言的帐号去回复网友的评论，以及去评论其他的使用友言的博客，因为这样更方便管理评价。不过在博客的评论框处并没有提供登录友言的方式，还需要你先打开友言的网站登录友言，然后这边才会登录上，这点还真是有点蛋疼
