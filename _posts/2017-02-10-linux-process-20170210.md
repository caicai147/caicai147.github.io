...
int main()
{
  ...
  if((pid_t)0 < pid){
    ...
    for(i=0; i<3; i++){
      ...
      //发送数据给子进程
      write(mypipearr[i][1], "Hello My Son\n", 14);
    }
    sleep(3);
  }
