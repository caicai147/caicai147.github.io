...
if __name__ == '__main__':
    re_td = r'<td>(.*?)</td>'
    m_td = re.findall(re_td, html, re.S|re.M)
    print '输出<td>之间的所有信息: '
    for line in m_td:
        print '      ', line

    re_url = r'<a[^>]+href=["\'](.*?)["\']'
    m_url = re.findall(re_url, html, re.S|re.M)
    print '输出所有的URL: '
    for line in m_url:
        print '      ', line

    re_li = r'<li>(.*?)</li>'
    m_li = re.findall(re_li, html, re.S|re.M)
    print '输出所有的列表: '
    for line in m_li:
        print '      ', line
    ...
    for line in m_url:
        ...
        if match is not None:
            print '      ', line, ' 匹配模式 www.x.*?r.com'
        else:
            print '      ', line, ' 不匹配模式 www.x.*?r.com'
