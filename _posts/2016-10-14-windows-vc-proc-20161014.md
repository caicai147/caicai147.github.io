...
Proc 既可以编译得到C 源码，也可以编译得到 C++源码，上面的例子是Proc 编译得到C 源码，但是这个dll 工程是将Proc 编译得到C++ 源码

修改D:\pro\xumeng13245\product\11.2.0\client_1\precomp\admin\pcscfg.cfg
