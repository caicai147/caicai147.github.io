...
包含变量 ![image](../image/2016-01-19/10.png) 的模板就是V：View，View负责显示逻辑，通过简单地替换一些变量，View最终输出的就是用户看到的HTML。
...
在Jinja2模板中，我们用 ![image](../image/2016-01-19/10.png) 表示一个需要替换的变量。很多时候，还需要循环、条件判断等指令语句，在Jinja2中，用 ![image](../image/2016-01-19/11png) 表示指令。
...
* [Django](https://www.djangoproject.com/)：Django是一站式框架，内置一个用 ![image](../image/2016-01-19/11.png) 和 ![image](../image/2016-01-19/12.png) 的模板。
