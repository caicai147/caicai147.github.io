...
Flask通过render_template()函数来实现模板的渲染。和Web框架类似，Python的模板也有很多种。Flask默认支持的模板是jinja2，所以我们先直接安装jinja2：`$ easy_install jinja2`
...
![image](../image/2016-01-19/10.png)

**form.html:**

用来显示登录表单的模板：

![image](../image/2016-01-19/11.png)

**sigin-ok.html:**

登录成功的模板：

![image](../image/2016-01-19/12.png)
